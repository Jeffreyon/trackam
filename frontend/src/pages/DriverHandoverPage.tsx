...
import {
  ...
  Package, Phone, Hash, ChevronRight,
} from "lucide-react";
import { QRCodeSVG } from "qrcode.react";
import { custodianApi, publicWaybillApi, ACTOR_LABELS, type ActorType } from "@/services/handover";
...
export default function DriverHandoverPage() {
  ...
  async function handleVerifyOtp(e: React.FormEvent) {
    ...
    try {
      ...
      setCustody(info);
      // Fetch full cross-operator chain for visibility
      if (info.waybillId) {
