...
import {
  Loader2, CheckCircle2, Building2, Fuel, AlertTriangle, Globe, Clock, Plug, Wallet, Truck,
} from "lucide-react";
...
import CarrierProfilePage from "../network/CarrierProfilePage";
...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      {tab === "carrier"      && <CarrierProfilePage />}
    </div>
  );
}
